...
x = tf.constant([[0, -2, -1], [0, 1, 2]], dtype=tf.int8)
y = tf.zeros_like(x)
out = tf.equal(x, y)
...
x = tf.random_normal([300], mean=0, stddev=0.1)
y = tf.random_normal([300], mean=0, stddev=0.1)
